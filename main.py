"""
Author: Rafy K.
This script was created by Rafy K. for automated Orbit mission analysis using GMAT and STK. 
It is modular in a way that allows for easy modification and extension.

You are free to use, modify, and distribute this code for any purpose, provided that this notice remains intact.
